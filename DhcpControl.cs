...
namespace CCSoundTrans
{
    public class SSHTransfer
    {
        ...
        public string ListFile(string srcdir)
        {
            if (!SSHdir.Connected)
                return "";
            ...
            try
            {
                string komut = "ls " + srcdir;
                //silme komutu
                returncommand = SSHdir.RunCommand(komut);
        ...
        public bool RenameFile(string srcfile,string destfile)
        {
            if (!SSHdir.Connected)
                return false;
            ...
            try
            {
                ...
                string komut = "mv " + srcfile + " " + destfile;
                //silme komutu
                SSHdir.RunCommand(komut);
                return true;
            }
